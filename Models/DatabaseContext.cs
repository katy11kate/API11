...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseLazyLoadingProxies().UseMySql("server=db;database=project;password=root;user=root", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.34-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdConsignmen).HasName("PRIMARY");

            entity.ToTable("consignmentlist");

            entity.HasIndex(e => e.IdProduct, "product_idx");

            entity.Property(e => e.IdConsignmen)
                .ValueGeneratedNever()
                .HasColumnName("id_consignmen");
            entity.Property(e => e.IdProduct).HasColumnName("id_product");

            entity.HasOne(d => d.IdConsignmenNavigation).WithOne(p => p.Consignmentlist)
                .HasForeignKey<Consignmentlist>(d => d.IdConsignmen)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("consi");
        ...
        modelBuilder.Entity<Orderlist>(entity =>
        {
            ...
            entity.HasOne(d => d.WarehouseNavigation).WithMany(p => p.Orderlists)
        ...
        modelBuilder.Entity<StatusChange>(entity =>
        {
            ...
            entity.HasIndex(e => e.IdStatus, "st_idx");
            ...
            entity.HasOne(d => d.IdStatusNavigation).WithMany(p => p.StatusChanges)
